  ...
  return (
    <section className="relative w-full bg-dark rounded-b-[100px]">
      <div className="relative min-h-[100vh] md:min-h-[750px] lg:min-h-[900px] ">
        ...
        {/* Content */}
        <div className="relative z-10 flex flex-col justify-end h-full min-h-[100vh] md:min-h-[750px] lg:min-h-[900px] px-8 md:px-10 lg:px-[160px] pb-16 lg:pb-24">
          <div className="flex flex-col lg:flex-row lg:items-end gap-8 lg:gap-10">
            ...
            <div className="flex-1">
              ...
              <h1 className="text-dark-foreground font-extrabold text-4xl md:text-7xl lg:text-[90px] leading-[1.03] tracking-[-2.4px] -mt-[32rem]">
            ...
            <div className="lg:max-w-[480px]">
              <p className="text-dark-foreground font-bold text-xl md:text-[30px] leading-[42px] -mt-[24rem]">
          ...
          {/* Feature tags */}
          <div className=" relative hidden grid grid-cols-2 md:grid-cols-4 gap-72   mt-12 lg:mt-16">
            {[
              { num: "01", label: "CNC" },
              { num: "02", label: "VMC" },
