...
const LogosSection = () => {
  return (
    <section className="w-full bg-secondary rounded-b-[40px] md:rounded-b-[80px] lg:rounded-b-[100px] py-12 md:py-20 overflow-hidden">
      <motion.div 
        initial={{ opacity: 0, y: 20 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
        transition={{ duration: 0.6 }}
        className="max-w-[1600px] mx-auto px-6 md:px-10 lg:px-[160px]"
      >
        <div className="flex flex-col md:flex-row items-center gap-8">
